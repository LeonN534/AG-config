...
Scheme
{
	...
	Colors
	{
		...
		"BrightControlText"	"232 232 69 255"	// use for selected controls
		"DisabledText1"		"117 128 111 255"	// disabled text - find server conect
		"DisabledText2"		"40 46 34 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"0 255 255 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"0 0 0 130"		// background color of controls
		...
		"SelectionBG"		"111 118 111 255"	// background color of any selected text or menu item
		"SelectionBG2"		"0 0 0 130"		// selection background in window w/o focus
		...
		// slider tick colors
		"SliderTickColor"	"100 100 100 255"
		"SliderTrackColor"	"31 31 31 255"

		// border colors
		"BorderBright"		"255 255 255 130"	// the lit side of a control
		"BorderDark"		"198 198 198 130"		// the dark/unlit side of a control
